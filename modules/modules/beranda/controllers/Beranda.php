...
class Beranda extends CI_Controller {
	...
	function __construct()
	{
     ...
     {
          $this->db_from->delete('cart');
          $this->db_from->where('cart_id', $id);
          redirect('beranda/keranjang');
     ...
     public function about()
     {
      ...
      public function sd_email() {
      $config = [
      'mailtype' => 'html',
      'charset' => 'utf-8',
      'protocol' => 'smtp',
      'smtp_host' => 'ssl://smtp.gmail.com',
      'smtp_user' => 'faraday@gmail.com', 
      'smtp_pass' => 'far123', 
      'smtp_port' => 465,
      'crlf' => "\r\n",
      'newline' => "\r\n"
      ...
      $this->email->from('no-reply@dinustek.com', RollinCigar.com | Mr. Cigar');
      
      $this->email->to('lufena@gmail.com'); 
      $this->email->attach('File.png');
      $this->email->subject('Kirim Email dengan SMTP Gmail');
      $this->email->message("Ini adalah contoh email CodeIgniter yang dikirim menggunakan SMTP email Google (Gmail).<br><br> Klik <strong><a href='https:RollinCIgar.com
      if ($this->email->send()) {
